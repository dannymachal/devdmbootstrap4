<form role="search" method="get" class="search-form form" action="<?php echo esc_url(get_site_url()); ?>">
    <div class="input-group">
        ...
        <input type="search" class="search-field form-control" placeholder="<?php esc_html_e('Search ...','devdmbootstrap4'); ?>" value="" name="s" title="<?php echo esc_attr('Search for:','devdmbootstrap4'); ?>">
